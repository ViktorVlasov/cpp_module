...
/*   Updated: 2021/01/26 23:26:52 by efumiko          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(const std::string &name) : hp(100), max_hp(100), ep(100), max_ep(100),
                        ...
                        armor_damage_reduction(5)
{
    std::cout << "ClapTrap with name " << name << " was created!" << std::endl;
}
...
ClapTrap::~ClapTrap() { std::cout << "ClapTrap with name " << this->name << " was killed!" << std::endl; }
